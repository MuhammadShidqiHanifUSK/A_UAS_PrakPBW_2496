<x-layouts::app title="Riwayat Setoran Saya">
...
<div class="hafalan-wrap">
    <div class="hafalan-header">
        <div class="hafalan-title-wrap">
            ...
            <div>
                <h1 class="hafalan-title">Riwayat Setoran Saya</h1>
                <p class="hafalan-subtitle">{{ auth()->user()->name }}</p>
            </div>
        </div>
    </div>
            ...
            <tbody>
                @forelse($setorans as $setoran)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('santri.show', $setoran->id) }}" class="btn-detail">Detail</a>
                        </td>
                    </tr>
                @empty
                    <tr>
